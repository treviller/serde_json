//! A map of String to serde_json_2::Value.
//!
//! By default the map is backed by a [`BTreeMap`]. Enable the `preserve_order`
//! feature of serde_json_2 to use [`IndexMap`] instead.
//!
...
/// #
/// # let mut map = serde_json_2::Map::new();
/// # map.insert("key".to_owned(), serde_json_2::Value::Null);
/// #
/// map["key"] = json!("value");
/// ```
...
/// An iterator over a serde_json_2::Map's entries.
pub struct Iter<'a> {
    iter: IterImpl<'a>,
}
...
/// A mutable iterator over a serde_json_2::Map's entries.
...
/// An owning iterator over a serde_json_2::Map's entries.
pub struct IntoIter {
    iter: IntoIterImpl,
}
...
/// An iterator over a serde_json_2::Map's keys.
pub struct Keys<'a> {
    iter: KeysImpl<'a>,
}
...
/// An iterator over a serde_json_2::Map's values.
pub struct Values<'a> {
    iter: ValuesImpl<'a>,
}
...
/// A mutable iterator over a serde_json_2::Map's values.
